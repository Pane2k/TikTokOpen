...
async def main():
    async with TikTokApi() as api:
        ...
        video = api.video(
            url="https://www.tiktok.com/@kakusnarezki/video/7429745300215991560"
        )
        videoInfo = await video.info()
        videoHashtag = video.stats
        # for vht in videoHashtag:
        #     if(vht.name == "костиккакто"):
        #         print(vht.name)
        print(videoHashtag)
